...
export const OfferScreen = observer(function OfferScreen() {
  ...
  return (
    <View>
      ...
      <View>
        <FlatList
          data={extraStore.offers}
          renderItem={({ item, index }) => (
            <View key={index} style={{ width: 200, height: 120, borderWidth: 1, alignSelf: 'center', marginTop: 20 }}>
              <TouchableOpacity onPress={() => navigation.navigate('offerdetail', { ID: item.id })}>
