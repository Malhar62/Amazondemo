            ...
            <View style={{ flexDirection: 'row' }}>
              ...
              <TouchableOpacity onPress={() => navigation.navigate('itemdetail', { user: item })}>
                <View style={{ marginLeft: 10, width: WIDTH(250), justifyContent: 'space-between', height: HEIGHT(130) }}>
                  ...
                  <Text style={{ fontSize: 20, marginTop: 10 }}>Rs.{item.price}</Text>
                  <View style={{ flexDirection: 'row', marginTop: 10, width: WIDTH(100), justifyContent: 'space-between', backgroundColor: '#87b0c9', borderRadius: 0 }}>
