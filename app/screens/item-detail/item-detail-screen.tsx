      ...
      <ScrollView
        ...
        <View style={{ marginTop: 10 }}>
          ...
          <View>
            ...
            <View elevation={5} style={{ right: 0, marginTop: 40, position: 'absolute', justifyContent: 'center', borderWidth: 0, width: 40, height: 40, borderRadius: 20, alignItems: 'center', backgroundColor: 'black' }} >
              <FontAwesome5 name='less-than' size={20} color='#fff' onPress={() => scroll1.current.scrollToOffset(0, 0, true)} />
            </View>
          </View>
        </View>
        <View style={{ marginTop: 20 }}>
          ...
          <View>
            ...
            />
            <View elevation={5} style={{ right: 0, marginTop: 40, position: 'absolute', justifyContent: 'center', borderWidth: 0, width: 40, height: 40, borderRadius: 20, alignItems: 'center', backgroundColor: 'black' }} >
              <FontAwesome5 name='less-than' size={20} color='#fff' onPress={() => scroll.current.scrollToOffset(0, 0, true)} />
            </View>
          </View>
        </View>
      </ScrollView>
